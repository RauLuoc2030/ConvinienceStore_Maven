 ...
 * @author Locc
 */
public class QLKho_HQT extends javax.swing.JPanel {
    ...
    public QLKho_HQT() {
        ...
        for (int i = 0; i < khoVanBUS.getList_KhoVanDTOs().size(); i++) {
            LoHang_HQT loHang = new LoHang_HQT(khoVanBUS.getList_KhoVanDTOs().get(i));
            jPanel4.add(loHang);
        }
        jPanel4.revalidate();
        jPanel4.repaint();
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        ...
        for (int i = components.length - 1; i >= 0; i--) {
            ...
            if (component instanceof LoHang_HQT) {
                LoHang_HQT loHang = (LoHang_HQT) component;
...
//                        System.out.println("Lỗi ràng buộc khóa ngoại");
    ...
    private void jPanelSave1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelSave1MouseClicked
        ...
        try {
            ...
            LoHang_HQT loHang = new LoHang_HQT(khoDTO);
            jPanel4.add(loHang);
            jPanel4.revalidate();
            jPanel4.repaint();
            ...
            ex.printStackTrace();
            Logger.getLogger(QLKho_HQT.class.getName()).log(Level.SEVERE, null, ex);
        }
